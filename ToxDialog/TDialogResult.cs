namespace ToxDialog
{
    public enum TDialogResult
    {
        ...
        /// <summary>
        /// The dialog return value is Close (usually sent from a button labeled Close).
        /// </summary>
        Close = 3,
        ...
        /// <summary>
        /// The dialog return value is YesToAll (usually sent from a button labeled Yes to All).
        /// </summary>
        YesToAll = 6,

        /// <summary>
        /// The dialog return value is NoToAll (usually sent from a button labeled No to All).
        /// </summary>
        NoToAll = 7,
        ...
        /// <summary>
        /// The dialog return value is Continue (usually sent from a button labeled Continue).
        /// </summary>
        Continue = 11
    }
}